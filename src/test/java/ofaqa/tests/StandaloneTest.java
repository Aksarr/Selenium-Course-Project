...
public class StandaloneTest {
	...
	public static void main(String[] args) {
		...
		Boolean match = cart.stream().anyMatch(product -> product.getText().equalsIgnoreCase("ZARA COAT 3"));
		Assert.assertTrue(match);
		driver.findElement(By.cssSelector(".totalRow button")).click();
		Actions a = new Actions(driver);
		a.sendKeys(driver.findElement(By.cssSelector("[placeholder='Select Country']")), "Norway").build().perform();
